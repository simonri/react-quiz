...
!function (a, b) {
  ...
  r.fn = r.prototype = {
    ...
    for ("boolean" == typeof g && (j = g, g = arguments[h] || {}, h++), "object" == (0, _typeof2["default"])(g) || r.isFunction(g) || (g = {}), h === i && (g = this, h--); h < i; h++) {
            ...
            return function () {
              var h = this,
                ...
                if (!(b < f)) {
                  ...
                  j = a && ("object" == (0, _typeof2["default"])(a) || "function" == typeof a) && a.then, r.isFunction(j) ? e ? j.call(a, g(f, c, N, e), g(f, c, O, e)) : (f++, j.call(a, g(f, c, N, e), g(f, c, O, e), g(f, c, N, c.notifyWith))) : (d !== N && (h = void 0, i = [a]), (e || c.resolveWith)(h, i));
                }
              },
                  k = e ? j : function () {
                try {
    ...
    style: function style(a, b, c, d) {
      if (a && 3 !== a.nodeType && 8 !== a.nodeType && a.style) {
        var e,
            ...
            i = Ra.test(b),
            j = a.style;
        return i || (b = Xa(h)), g = r.cssHooks[b] || r.cssHooks[h], void 0 === c ? g && "get" in g && void 0 !== (e = g.get(a, !1, d)) ? e : j[b] : (f = (0, _typeof2["default"])(c), "string" === f && (e = ba.exec(c)) && e[1] && (c = fa(a, b, e), f = "number"), null != c && c === c && ("number" === f && (c += e && e[3] || (r.cssNumber[h] ? "" : "px")), o.clearCloneStyle || "" !== c || 0 !== b.indexOf("background") || (j[b] = "inherit"), g && "set" in g && void 0 === (c = g.set(a, c, d)) || (i ? j.setProperty(b, c) : j[b] = c)), void 0);
      }
    },
  ...
  r.Animation = r.extend(kb, {
    ...
    var d = a && "object" == (0, _typeof2["default"])(a) ? r.extend({}, a) : {
  ...
  r.extend(r.event, {
    trigger: function trigger(b, c, e, f) {
      ...
      if (h = i = e = e || d, 3 !== e.nodeType && 8 !== e.nodeType && !sb.test(p + r.event.triggered) && (p.indexOf(".") > -1 && (q = p.split("."), p = q.shift(), q.sort()), k = p.indexOf(":") < 0 && "on" + p, b = b[r.expando] ? b : new r.Event(p, "object" == (0, _typeof2["default"])(b) && b), b.isTrigger = f ? 2 : 3, b.namespace = q.join("."), b.rnamespace = b.namespace ? new RegExp("(^|\\.)" + q.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, b.result = void 0, b.target || (b.target = e), c = null == c ? [b] : r.makeArray(c, [b]), n = r.event.special[p] || {}, f || !n.trigger || n.trigger.apply(e, c) !== !1)) {
  ...
  function Ab(a, b, c, d) {
    ...
    if (Array.isArray(b)) r.each(b, function (b, e) {
      c || wb.test(a) ? d(a, e) : Ab(a + "[" + ("object" == (0, _typeof2["default"])(e) && null != e ? b : "") + "]", e, c, d);
  ...
  r.extend({
    ...
    ajax: function ajax(b, c) {
      "object" == (0, _typeof2["default"])(b) && (c = b, b = void 0), c = c || {};
      var e,
          f,
          g,
          h,
  ...
  r.ajaxSetup({
    ...
    var d,
        ...
        g = this,
        h = a.indexOf(" ");
    return h > -1 && (d = pb(a.slice(h)), a = a.slice(0, h)), r.isFunction(b) ? (c = b, b = void 0) : b && "object" == (0, _typeof2["default"])(b) && (e = "POST"), g.length > 0 && r.ajax({
      url: a,
      type: e || "GET",
      dataType: "html",
      data: b
